...
<div class="banner-small">
    ...
    <h1>Jering.<wbr>Javascript.<wbr>NodeJS</h1>
    <!-- Use p so it is used in search snippet -->
    <p>Invoke Javascript in <a href="https://nodejs.org">NodeJS</a>, from C#</p>
</div>
<div class="content">
    <div class="card-set card-small">
        ...
        <section class="card">
            ...
            <a href="https://github.com/JeringTech/Javascript.NodeJS" class="card-body">
                <header>
                    <h3>Github</h3>
                </header>
        ...
        <section class="card">
            ...
            <a href="https://www.nuget.org/packages/Jering.Javascript.NodeJS/" class="card-body">
                <header>
                    <h3>Nuget</h3>
                </header>

...
namespace Jering.JavascriptUtils.Node.HostingModels
{
    ...
    {
        /// <summary>
        /// Asynchronously invokes code from a file in the Node.js instance.
        /// </summary>
        ...
        /// <param name="exportName">If set, specifies the CommonJS export to be invoked. If not set, the module's default CommonJS export itself must be a function to be invoked.</param>

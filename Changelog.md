...
### Fixes
- Fixed index out of bounds exception thrown when Javascript log message contains an empty line. ([#55](https://github.com/JeringTech/Javascript.NodeJS/pull/55))
